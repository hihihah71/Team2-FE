                  ...
                  <div className="profile-section-fade">
                    ...
                    <div className="profile-form-grid">
                      ...
                      <div className="profile-form-group">
                        ...
                        <input type="text" name="fullName" className="profile-input" value={personalInfo.fullName} onChange={handlePersonalChange} placeholder="Nhập họ tên của bạn..." />
                      </div>
                      ...
                      <div className="profile-form-group">
                        ...
                        <input type="tel" name="phone" className="profile-input" value={personalInfo.phone} onChange={handlePersonalChange} placeholder="Nhập số điện thoại..." />
                      </div>

                      <div className="profile-form-group full-width">
                        <label className="profile-label">Địa chỉ Email</label>
                        <input type="email" name="email" className="profile-input" value={personalInfo.email} onChange={handlePersonalChange} placeholder="Email liên hệ..." />
                      </div>
                ...
                <div className="profile-section-fade">
                  ...
                  <div className="profile-form-grid">
                    <div className="profile-form-group full-width">
                      ...
                      <input type="text" name="companyName" className="profile-input" value={companyInfo.companyName} onChange={handleCompanyChange} placeholder="Tên công ty..." />
                    </div>
